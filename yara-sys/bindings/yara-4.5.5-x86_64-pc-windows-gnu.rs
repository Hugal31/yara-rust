...
const _: () = {
    ...
    ["Offset of field: _YR_STOPWATCH::frequency"]
        [::std::mem::offset_of!(_YR_STOPWATCH, frequency) - 0usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _YR_COMPILER"][::std::mem::size_of::<_YR_COMPILER>() - 13600usize];
    ["Alignment of _YR_COMPILER"][::std::mem::align_of::<_YR_COMPILER>() - 16usize];
    ...
    ["Offset of field: _YR_COMPILER::error_recovery"]
        [::std::mem::offset_of!(_YR_COMPILER, error_recovery) - 64usize];
    ["Offset of field: _YR_COMPILER::automaton"]
        [::std::mem::offset_of!(_YR_COMPILER, automaton) - 320usize];
    ["Offset of field: _YR_COMPILER::rules_table"]
        [::std::mem::offset_of!(_YR_COMPILER, rules_table) - 328usize];
    ["Offset of field: _YR_COMPILER::objects_table"]
        [::std::mem::offset_of!(_YR_COMPILER, objects_table) - 336usize];
    ["Offset of field: _YR_COMPILER::strings_table"]
        [::std::mem::offset_of!(_YR_COMPILER, strings_table) - 344usize];
    ["Offset of field: _YR_COMPILER::wildcard_identifiers_table"]
        [::std::mem::offset_of!(_YR_COMPILER, wildcard_identifiers_table) - 352usize];
    ["Offset of field: _YR_COMPILER::sz_table"]
        [::std::mem::offset_of!(_YR_COMPILER, sz_table) - 360usize];
    ["Offset of field: _YR_COMPILER::fixup_stack_head"]
        [::std::mem::offset_of!(_YR_COMPILER, fixup_stack_head) - 368usize];
    ["Offset of field: _YR_COMPILER::num_namespaces"]
        [::std::mem::offset_of!(_YR_COMPILER, num_namespaces) - 376usize];
    ["Offset of field: _YR_COMPILER::loop_"]
        [::std::mem::offset_of!(_YR_COMPILER, loop_) - 384usize];
    ["Offset of field: _YR_COMPILER::loop_index"]
        [::std::mem::offset_of!(_YR_COMPILER, loop_index) - 800usize];
    ["Offset of field: _YR_COMPILER::loop_for_of_var_index"]
        [::std::mem::offset_of!(_YR_COMPILER, loop_for_of_var_index) - 804usize];
    ["Offset of field: _YR_COMPILER::file_name_stack"]
        [::std::mem::offset_of!(_YR_COMPILER, file_name_stack) - 808usize];
    ["Offset of field: _YR_COMPILER::file_name_stack_ptr"]
        [::std::mem::offset_of!(_YR_COMPILER, file_name_stack_ptr) - 936usize];
    ["Offset of field: _YR_COMPILER::last_error_extra_info"]
        [::std::mem::offset_of!(_YR_COMPILER, last_error_extra_info) - 940usize];
    ["Offset of field: _YR_COMPILER::lex_buf"]
        [::std::mem::offset_of!(_YR_COMPILER, lex_buf) - 1196usize];
    ["Offset of field: _YR_COMPILER::lex_buf_ptr"]
        [::std::mem::offset_of!(_YR_COMPILER, lex_buf_ptr) - 9392usize];
    ["Offset of field: _YR_COMPILER::lex_buf_len"]
        [::std::mem::offset_of!(_YR_COMPILER, lex_buf_len) - 9400usize];
    ["Offset of field: _YR_COMPILER::include_base_dir"]
        [::std::mem::offset_of!(_YR_COMPILER, include_base_dir) - 9402usize];
    ["Offset of field: _YR_COMPILER::user_data"]
        [::std::mem::offset_of!(_YR_COMPILER, user_data) - 13504usize];
    ["Offset of field: _YR_COMPILER::incl_clbk_user_data"]
        [::std::mem::offset_of!(_YR_COMPILER, incl_clbk_user_data) - 13512usize];
    ["Offset of field: _YR_COMPILER::re_ast_clbk_user_data"]
        [::std::mem::offset_of!(_YR_COMPILER, re_ast_clbk_user_data) - 13520usize];
    ["Offset of field: _YR_COMPILER::callback"]
        [::std::mem::offset_of!(_YR_COMPILER, callback) - 13528usize];
    ["Offset of field: _YR_COMPILER::include_callback"]
        [::std::mem::offset_of!(_YR_COMPILER, include_callback) - 13536usize];
    ["Offset of field: _YR_COMPILER::include_free"]
        [::std::mem::offset_of!(_YR_COMPILER, include_free) - 13544usize];
    ["Offset of field: _YR_COMPILER::re_ast_callback"]
        [::std::mem::offset_of!(_YR_COMPILER, re_ast_callback) - 13552usize];
    ["Offset of field: _YR_COMPILER::atoms_config"]
        [::std::mem::offset_of!(_YR_COMPILER, atoms_config) - 13560usize];
};
